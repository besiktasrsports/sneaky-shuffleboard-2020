...
public class Robot extends TimedRobot {
  ...
  SendableChooser<Double> currentVoltage = new SendableChooser<>();
  ...
  public void robotInit() {
    ...
    currentVoltage.addDefault("voltage", pdp.getVoltage());
    SmartDashboard.putData("Autonomous Selector", autoChooser);
    m_gyro.updateDashboard();
  ...
  public void autonomousInit() {
    int autoMode = autoChooser.getSelected(); // Simple switch-case would work for the next step
